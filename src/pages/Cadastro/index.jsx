            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="index.html" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="email" name="email" placeholder="Insira seu melhor email" />
                </div>
                <div class="mb-3 form-password-toggle">
                  <label class="form-label" for="password">Escolha uma senha forte</label>
                ...
                <button class="btn btn-primary d-grid w-100">Tudo pronto</button>
              </form>
